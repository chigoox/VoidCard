...
export function CropModal({
  ...
  return (
    <div
      className="safe-modal-sheet fixed inset-0 z-50 flex items-end justify-center overflow-y-auto bg-black/80 backdrop-blur-sm sm:items-center"
      role="dialog"
      aria-modal="true"
      aria-label="Crop image"
      data-testid="crop-modal"
    >
      <div className="safe-max-h-screen flex min-h-0 w-full flex-col gap-4 overflow-y-auto rounded-t-card border border-onyx-700 bg-onyx-950 p-4 sm:max-w-lg sm:rounded-card">
        <div>
        ...
        <div className="relative h-[min(38dvh,18rem)] min-h-48 w-full overflow-hidden rounded-card bg-black sm:h-80">
          <Cropper
            image={src}
            crop={crop}
            zoom={zoom}
