  ...
  return (
    <main className="home-theme relative min-h-screen overflow-hidden bg-onyx-grad">
      ...
      <div className="relative mx-auto grid min-h-screen max-w-6xl gap-10 px-6 py-8 lg:grid-cols-[1.08fr_0.92fr] lg:items-center lg:py-12">
        {/* Form — first in DOM so it renders above marketing content on mobile */}
        <section className="relative order-first flex items-center justify-center lg:order-last lg:justify-end">
        ...
        {/* Marketing content — second on mobile, first column on desktop */}
        <section className="order-last flex flex-col justify-between gap-10 py-2 lg:order-first lg:py-6">
